...
export default function ShoppingCardSidebar({ isOpen, onClose, cardItems }) {
            ...
            {itemArray.map((item) => (
              <div key={item.id} className="card-item">
                ...
                <div className="item-counter">
                  <button className="plus-btn" onClick={() => plusHandler(item.id)}>
                    +
                  </button>
                  <span>{item.count}</span>
                  <button className="mines-btn" onClick={() => minesHandler(item.id)}>
                    -
                  </button>
                </div>
              </div>
            ...
            <div className="sorat-hesab">
              ...
              <div className="second-row">
                <div className="price">
                  ...
                  <span className="price-number">1400000 تومان</span>
                </div>
                <div className="total-price">
                  <span className="total-title">مجموع</span>
                  <span className="total-number">1400000 تومان</span>
                </div>
              </div>
